...
import { HeroHighlight, Highlight } from "../components/hero-highlight.jsx";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
      ...
      <div className="relative z-10 pt-10">
        <HeroHighlight>
          ...
          >
            Welcome to <Highlight className="text-white">Socion</Highlight>
          </motion.h1>
        </HeroHighlight>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mt-8 px-4 md:px-12 mx-auto">
        <CardContainer className="inter-var w-full">
          ...
          >
            ...
            >
              Uncover key statistics from Instagram posts. Analyze engagement,
              reach, and audience demographics to optimize your social media
              strategy
            </CardItem>
        ...
        <CardContainer className="inter-var w-full">
          ...
          >
            ...
            <CardItem
              ...
              className="text-white text-sm max-w-sm mt-2 dark:text-neutral-300"
            >
              Gain valuable insights through statistical analysis of X posts.
              Track key metrics like impressions, engagement rates, and
              sentiment to inform your social media decisions
            </CardItem>
