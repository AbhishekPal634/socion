		...
		<div
			className={`max-w-[80%] p-3 rounded-lg ${
				isBot
					...
					: 'bg-black dark:bg-gray-800 text-white rounded-tr-none'
			}`}>
			{message}
		</div>
		{!isBot && (
			<div className='flex-shrink-0 w-8 h-8 rounded-full bg-black dark:bg-gray-800 flex items-center justify-center'>
...
const ChatInput = ({ onSend }) => {
	...
	return (
		<form
			...
			className='flex gap-2 p-4 border-t border-gray-200 dark:border-grey bg-white dark:bg-black'>
			<input
				type='text'
				value={message}
			...
			<button
				type='submit'
				className='p-2 text-white bg-black dark:bg-gray-800 
            border border-transparent dark:border-gray-600 
            rounded-lg hover:bg-gray-800 dark:hover:bg-gray-700 
            transition-colors'>
				<Send size={20} />
			</button>
		</form>
